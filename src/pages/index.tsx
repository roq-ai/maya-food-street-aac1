  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Maya Food Street - Your Digital Gateway to Exquisite Cuisines. Making Food Shop Websites Delightfully Simple and Efficient."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Maya Food Street - Your Digital Gateway to Exquisite Cuisines. Making Food Shop Websites Delightfully Simple and Efficient.`}
            </Text>
            <Box
